...
#SBATCH --output=EU_moco_FT_rn50_%j.out
#SBATCH --error=EU_moco_FT_rn50_%j.err
...
--bands B13 \
--checkpoints_dir /mnt/beegfs/bulk/mirror/jyf6/datasets/geospatial/SSL4EO-S12/src/benchmark/public_checkpoints/moco_ft/EU_rn50 \
--backbone resnet50 \
--train_frac 1.0 \
--batchsize 64 \
--lr 0.1 \
